...
*A data-driven recommender built from real Xbox player engagement behavior.*
...
- Produces a structured analytics dataset (`xbox_sample.duckdb`)
...
│   └── xbox_sample.duckdb       # Reduced + optimized DuckDB snapshot
│
...
│
├── build_data.py                # Feature construction + dataset merging
├── evaluator.py                 # Core evaluation + ranking logic
├── ranking_curve.png            # Precision–Recall curves
├── confusion_matrix_cf.png      # CF confusion matrix
│
├── final_report.md              # Polished 3-page technical whitepaper
├── report1.md                   # Initial draft
│
